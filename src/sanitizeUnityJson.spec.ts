...
describe('sanitizeUnityJson', () => {
  ...
  it('should parse known blocks in a scene', async () => {
    const result = await sanitizeUnityJson({
      unitySceneName: 'SampleScene',
      unityContext: unityProject,
    });
    ...
    expect(
      ...
      instances: [{
        props: {
          ...
          'm_LocalPosition.x': '0.105',
          'm_LocalPosition.y': '0.24',
          'm_LocalPosition.z': '-1.773',
        ...
        props: {
          ...
          transform: {
            ...
            m_LocalPosition: { x: '-0.045', y: '0.067', z: '-3.328' },
            m_LocalRotation: {
      ...
      references: { de54e5715f7b258448ead4fd3567c9a0: 'Z2xURgIAAADsdAAAOBUAAEpTT057C=' },
    });
  });
